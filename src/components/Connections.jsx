...
const Connections = () => {
  ...
  return (
    <section
      className="min-h-screen bg-gradient-to-b from-[#020013] via-cyan-800/5 to-[#020013] px-6 py-8 text-white relative"
      style={{
        backgroundImage: "url('/main-bg.png')",
      }}
    >
      <div className="max-w-6xl mx-auto">
        {/* Back button (absolute on large screens, static on small screens) */}
