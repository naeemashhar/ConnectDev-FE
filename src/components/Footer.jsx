...
const Footer = () => {
  return (
    <footer className="fixed bottom-0 w-full bg-base-200 text-base-content px-6 py-4 z-50">
      <div className="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="text-xs md:text-sm opacity-70 text-center md:text-right text-white">
