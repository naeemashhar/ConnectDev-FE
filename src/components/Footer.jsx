const Footer = () => {
  return (
    <footer className="fixed bottom-0 w-full bg-[#f4ede3] dark:bg-base-200 text-[#021431] dark:text-base-content px-6 py-4 z-50 shadow-inner">
  <div className="flex flex-col md:flex-row justify-between items-center gap-4">
    {/* Left: Logo */}
    <div className="flex items-center space-x-2">
      <span className="text-2xl font-mono text-cyan-500">&lt;&#9679;&gt;</span>
