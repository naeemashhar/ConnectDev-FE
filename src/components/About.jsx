...
const About = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#020013] via-cyan-500/10 to-[#020013] text-base-content px-4 py-16">
      {/* Back Button */}
      <button
        onClick={() => navigate(-1)}
      ...
      <div className="max-w-5xl mx-auto text-center mt-12 md:mt-24 px-2">
        ...
        <p className="text-base md:text-lg text-white/80 max-w-3xl mx-auto mb-12 leading-relaxed">
          Connect.dev is more than a platform — it's a professional playground for developers. Whether you're looking for collaborators, mentors, or friendships rooted in code and creativity, this is where your journey begins.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[
            ...
            <div
              key={i}
              className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-white/10 shadow-md hover:shadow-xl hover:shadow-cyan-500/10 transition"
            >
        ...
        <div className="mt-20 bg-white/5 p-6 rounded-xl border border-white/10 max-w-3xl mx-auto text-left">
          <h3 className="text-xl font-bold text-cyan-300 mb-3">🔍 How It Works</h3>
          <ul className="list-disc list-inside text-white/70 text-sm space-y-2">
            <li>Create your profile and highlight your dev stack and passions.</li>
