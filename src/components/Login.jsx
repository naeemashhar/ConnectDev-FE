...
const Login = () => {
  ...
  <button
    onClick={() => navigate("/")}
    className="cursor-pointer absolute top-4 left-4 px-4 py-2 text-md text-[#021431] dark:text-white rounded hover:bg-white/10 transition hover:text-cyan-500 flex items-center gap-2"
  >
...
/>
  ...
  <div className="flex items-center justify-center space-x-2">
    ...
    <span className="text-md dark:text-gray-300 text-[#021431]">or continue with</span>
    <span className="border-b w-1/5 border-[#021431] dark:border-gray-300"></span>
  </div>
  ...
  <p className="text-center text-md dark:text-gray-300 text-[#021431]">
    Are you new here?{" "}
    <Link to="/signup" className="dark:text-cyan-400 text-[#0069FF] hover:underline">
      Create an account
    </Link>
  </p>
</div>
